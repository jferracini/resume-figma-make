...
function ContactInfo() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-[151px] top-[4px] w-[482px]" data-name="Contact Info">
      <p className="leading-[normal] relative shrink-0 text-[#f1f1ef] text-[14px] tracking-[-0.28px]">Staff Product Designer</p>
      <ContactDetails />
    </div>
  );
}
...
function Container() {
  return (
    <div className="font-['Inter:Medium',sans-serif] font-medium h-[76px] not-italic relative shrink-0 w-full" data-name="Container">
      <div className="absolute h-[84px] leading-[46px] left-0 text-[#f1f1ef] text-[32px] top-[-8px] tracking-[-0.96px] w-[151px] whitespace-pre-wrap">
...
function Summary() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[17px] relative shrink-0" data-name="Summary">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#f1f1ef] text-[14px] uppercase">SUMMARY</p>
      <Content1 />
    </div>
  );
}
...
function CompanyInfo() {
  return (
    <div className="capitalize content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0" data-name="Company Info">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px] w-[125px] whitespace-pre-wrap">Nubank</p>
...
function CompanyInfo1() {
  return (
    <div className="capitalize content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0" data-name="Company Info">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">PicPay</p>
...
function ExperienceDetails1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Experience Details">
      <ExperienceItem1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.42] lowercase not-italic relative shrink-0 text-[#f1f1ef] text-[11px] tracking-[-0.22px] w-[470px] whitespace-pre-wrap">Directed the development and implementation of comprehensive design foundations enhancing system scalability and performance across multiple product lines.</p>
    </div>
  );
}
...
function CompanyInfo2() {
  return (
    <div className="capitalize content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0" data-name="Company Info">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">Itau</p>
...
function CompanyInfo3() {
  return (
    <div className="capitalize content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0" data-name="Company Info">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">Thoughtworks</p>
...
function ExperienceDetails3() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Experience Details">
      <ExperienceItem3 />
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[1.42] lowercase not-italic relative shrink-0 text-[#f1f1ef] text-[11px] tracking-[-0.22px] w-[470px] whitespace-pre-wrap">
...
function CompanyInfo4() {
  return (
    <div className="capitalize content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0" data-name="Company Info">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">BTG Pactual</p>
...
function CompanyInfo5() {
  return (
    <div className="capitalize content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0" data-name="Company Info">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">CCEE</p>
...
function ExperienceDetails5() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Experience Details">
      <ExperienceItem5 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.42] lowercase not-italic relative shrink-0 text-[#f1f1ef] text-[11px] tracking-[-0.22px] w-[470px] whitespace-pre-wrap">Created the company’s first design system, standardized legacy platforms, and integrated design with DevOps workflows, raising design maturity and accelerating delivery.</p>
    </div>
  );
}
...
function Experience() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[17px] relative shrink-0" data-name="Experience">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#f1f1ef] text-[14px] uppercase">Experience</p>
      <Experience1 />
    </div>
  );
}
...
function CompanyInfo6() {
  return (
    <div className="capitalize content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0" data-name="Company Info">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">{`User Experience & Beyond`}</p>
...
function CompanyInfo7() {
  return (
    <div className="capitalize content-stretch flex flex-col gap-[2px] items-start not-italic relative shrink-0" data-name="Company Info">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">Advertising</p>
...
function Education1() {
  return (
    <div className="content-stretch flex flex-col items-end mb-[-17px] relative shrink-0 w-[621px]" data-name="Education">
      <SectionTitle6 />
    </div>
  );
}
...
function Education() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[17px] relative shrink-0" data-name="Education">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#f1f1ef] text-[14px] uppercase">Education</p>
      <Education1 />
    </div>
  );
}
...
function SkillCategory() {
  return (
    <div className="capitalize content-stretch flex flex-col gap-[11px] items-start leading-[1.42] not-italic relative shrink-0" data-name="Skill Category">
      <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">Design</p>
...
function SkillCategory1() {
  return (
    <div className="content-stretch flex flex-col gap-[11px] items-start not-italic relative shrink-0" data-name="Skill Category">
      <p className="capitalize font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">Tools</p>
...
function SkillCategory2() {
  return (
    <div className="content-stretch flex flex-col gap-[11px] items-start not-italic relative shrink-0" data-name="Skill Category">
      <p className="capitalize font-['Inter:Medium',sans-serif] font-medium leading-[1.42] relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">Languages</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[1.465] relative shrink-0 text-[#787878] text-[11px] whitespace-nowrap">
...
function SkillCategory3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Skill Category">
      <p className="capitalize font-['Inter:Medium',sans-serif] font-medium leading-[1.42] not-italic opacity-0 relative shrink-0 text-[#f1f1ef] text-[15px] tracking-[-0.3px]">2026</p>
    </div>
  );
}
...
function Skills() {
  return (
    <div className="content-stretch flex items-start justify-between pr-[18px] relative shrink-0 w-full" data-name="Skills">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] mr-[-18px] not-italic relative shrink-0 text-[#f1f1ef] text-[14px] uppercase">Skills</p>
      <SkillsDetails />
    </div>
  );
}
...
export default function Cv2026JcDark() {
  return (
    <div className="bg-[#121212] content-stretch flex flex-col gap-[53px] items-center px-[26px] py-[54px] relative size-full" data-name="CV 2026 JC dark">
      <Container />
